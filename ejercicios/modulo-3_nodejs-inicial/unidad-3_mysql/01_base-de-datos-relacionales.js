...
A esta altura, uno puede preguntarse ¿Qué es lo interesante de usar una Base de Datos, si yo la información también la puedo guardar en archivos de texto bien organizados? Lo interesante de usar una base de datos como sistema para almacenar información en una computadora, en vez de usar un simple archivo de texto en donde guardamos los datos que nos interesan, es que a una base de datos se le pueden pedir datos.
