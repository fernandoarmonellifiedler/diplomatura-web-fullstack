...
Redux es un patrón de arquitectura de datos que permite manejar el estado de la
...
Redux se encarga en cierta manera de desacoplar el estado global de una aplicación web
(en Front-End) de la parte visual, es decir los componentes.

--------------------------------
Ventajas del uso de redux

Two way binding
Permite “enlazar” un input a una propiedad del estado, permitiendo que al modificar la
propiedad se modifique el input, y al modificar el input se modifique la propiedad
state = {
nombre: '' } constructor(props) {
super(props); this.handleChange
= this.handleChange.bind(this); } handleChange(e) {
this.setState({nombre: e.target.value}); } render() {
return (
<div className="row">
...
return item.id === id; })this.setState({
listado: [
...
--------------------------------
Manejo de estado
Cuando la aplicación comienza a ser más grande y compleja, cada vez es más difícil
...
Generalmente indicamos que acción deseamos realizar y los datos necesarios para
