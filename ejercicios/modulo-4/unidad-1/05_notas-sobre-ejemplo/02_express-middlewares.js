...
/*
    Note: Notice the call above to next(). Calling this function invokes the next middleware function in the app. The next() function is not a part of the Node.js or Express API, but is the third argument that is passed to the middleware function. The next() function could be named anything, but by convention it is always named “next”. To avoid confusion, always use this convention.
...
Extracted from http://expressjs.com/en/guide/writing-middleware.html*/
...
//For details about error-handling middleware, see: Error handling (http://expressjs.com/en/guide/error-handling.html).
...
Extracted from http://expressjs.com/en/guide/using-middleware.html#using-middleware
*/