/* Definición de base de datos, tablas, campos, índices y claves foráneas
...
Veamos la siguiente tabla, que muestra el ranking mundial de Tenis (seguramente está desactualizada)
...
En nuestra tabla Ranking, no serviría de mucho tener dos columnas llamadas “apellido”, a no ser que las usemos para almacenar el primer y segundo apellido de los tenistas. Pero en ese caso, deberíamos llamarlas con un nombre acorde a lo que contienen: “primer apellido” y “segundo apellido”.
...
Los campos Clave son campos (columnas) cuyo contenido va a ser único a lo largo de toda la tabla.
...
¿Cómo aplicamos esto a nuestra tabla de clientes? Lo que podemos hacer es agregar un campo clave denominado “nro_cliente” que represente un Número Único de Cliente, el cual utilizaremos para referirnos unívocamente a cada uno de ellos. 
...
Si queremos saber quién compró “50 Resmas A4”, sólo hace falta ver el Número de Cliente que está en la columna “nro_cliente” y luego ir a la tabla Clientes para ver a quien le corresponde ese número, que en este caso es “Silvia Lanzillotta”.
...
● nro_pedido es una Clave Primaria: En este caso, el campo clave identifica a cada orden de compra, por lo tanto es para registros que están dentro de la tabla.
...
Algo interesante para aclarar es que no tiene por qué haber sólo una clave primaria o foránea.

Esquemas
El conjunto de todos los diseños de las tablas de una BD se llama Esquema. Vendría a ser algo así como un plano de la Base. En el Esquema de la BD se muestran todas las tablas, junto con sus campos y claves primarias y/o foráneas.
