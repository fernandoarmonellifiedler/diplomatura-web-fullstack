...
The various errors returned by this module are described in the errors section. (https://www.npmjs.com/package/body-parser#errors)
...
The json function takes an optional options object that may contain any of the following keys:
    ...
    reviver
    The reviver option is passed directly to JSON.parse as the second argument. You can find more information on this argument in the MDN documetation about JSON.parse.
